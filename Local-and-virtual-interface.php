                ...
                <div class="col-xl-8 col-9 col-auto">                    
                    ...
                    <ul class="full-text">    
                        <li>
                            ...
                            <div class="stext">
                                <b>
                                    Posthuman Body and Visuality: local and virtual interface<br>
                                    Mrinal Kulkarni
                                </b><br><br>
                                ...
                                <br><br>
                                The widespread presence of visual media offers views of the world in visuals; they render the world in visual terms. These renderings are not innocent, but they interpret the world, present a world view, and represent it. The theoretical positions analyse and contextualise the image's meaning, body, vision, and visuality. Vision is what the human eye is physiologically capable of seeing, and visuality refers to how vision is constructed in various ways: 'how we see, how we are able, allowed, or made to see, and how we see this seeing and the unseeing therein' (Foster; Foster)<sub>2</sub> . Visuality and other terms of scopic regime refer to the ways in which what is seen and how it is seen are culturally constructed.
                                <br><br>
                        ...
                        <li>
                            ...
                            <div class="stext">
                                ...
                                <br><br>
                                Katherine Hayle stresses that the repositioning of materiality is distinct from physicality and re-envisioning the material basis for hybrid texts and subjectivities (Hayles). She also reiterates that the binary opposition between embodiment and information engaging with the materiality of literary texts broadens and deepens ideas into computation and textuality. Materiality for her is an emergent property created through dynamic interactions between physical characteristics and signifying strategies. She positions materiality as a junction between physical reality and human intention. Thus she relates Mother Nature with Motherboard. Nature, seen in earlier times as the source of human behaviour and physical reality, is now replaced by the Universal Computer. 
                                <br><br>
