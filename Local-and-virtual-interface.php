...
<body class="lang_tw">
    ...
    <div id="Wapper">
        ...
        <section class="row mb120">
            <div class="col-xl-8 col-9 col-auto">
                ...
                <p class="stext mb120">
                    ...
                    Discussions of posthuman realities often centre on how to map the online world in connection to offline reality and how online hierarchies and other forms of local access to global settings impact offline reality and online cultures. The hypervisuality of the photos places the body as an instrument and a venue for the local, global, and virtual interplay of offline located/situated producers and consumers and online global viewers. It demands a new perspective to study the concept of the posthuman body and visuality in the context of the current art practices to understand how the relationships of local technologies and the high technologies configure the idea of culture, how the economic structures of the high tech and the regional situations manifest in these artworks.<br><br>

                    Art history studies are predicated on the idea that seeing is a physical act of vision and visuality. The scopic regime equated seeing with knowing and got linked to the concepts of visibility, identity, and the debate surrounding gaze. Deconstructing the pictures produced as a result of visual experiences helped to develop the discourse. The proliferation of digital media transformed the relationship between the object's materiality and its representation. New Media art has explored the agency of material things and the particularities of digital media and questioned the representations' notions. It represents a simulated visuality of the body.<br><br>

                    New Media art takes further into representations, as it is no longer needed to keep the world in the "mind's eye" but build it walk through it and manipulate it. Thus it addresses digital media as an aesthetic experience. The influence of information in its materiality and how its physical features are mobilised as resources to produce meaning are also documented in new media artworks, which are embodied art forms. Art serves as a bridge between the human body, other works of art, and various mediums in this way.<br><br>

                    New media technologies rapidly altered the body's predominant visuality in visual culture and the visual arts. It demonstrated how the body simultaneously functions as a site of affect and a source of resistance to the notion of postmodernism's universal standards. The widespread presence of visual media offers views of the world in visuals; they render the world in visual terms. These renderings are not innocent, but they interpret the world, present a world view, and represent it.<br><br>

                    Visuality constructed through different technologies became a significant concern as it discussed the impact of external visual technologies on the socio-cultural level and a total reconfiguration of the interiority of persons. With the development of digital technology, visuality is seen as a practice of giving the raw, mathematical sequences of code in databases with anthropologically and culturally accepted forms. This aspect raises questions about the concept of the body and related visuality.<br><br>

                    The involvement of new technologies and art practices affected New Media art's aesthetical and compositional aspects. Like the new avant-garde of the 1920s, New Media art uses appropriation as a creative tool. The hyper abundance of source material, combined with the ubiquitous "copy" and "paste" features of computer software, further eroded the notion that creating something from scratch is better than borrowing it. Along with a penchant for collaboration and a marked tendency to appropriate rather than to create from scratch, this media-archaeological approach to art-making exemplifies the attenuation of authorial originality in New Media art.<br>
                    The Renaissance period metaphor of the window as a conical concept of vision persists in the digital age, most obviously in the title of Microsoft's famous operating system, Windows. But, besides the names, there is no similarity in both concepts. The digital window is very different from the windows of the Renaissance perspective or the cinema screen. The Renaissance window metaphor is a tool to look through, whereas the digital window concept is to look at.<br><br>

                    The New Media art aesthetics is not concerned with seeing or representing the world in new ways but rather with accessing and using previously accumulated media. In this respect, Lev Manovich terms new media as post-media or meta-media, using old media as its primary material.
                    New Media art projects explore the performative aspect of the media and challenge the inherited understandings of the body's place in a technological culture. As humans discover ways to upload their minds into computers and abandon their bodies, Hans Moravec refers to this as the "postbiological" future, where the assumption that the material embodiment has always served to define the bounds of the human would become optional. Katherine Hayle further discusses the evolution of new and more advanced posthumans. She claims that a particular facet of posthuman rhetoric, insofar as it equated the self with the mind and viewed the body as only a vehicle for the mind's activities, continues to reenact the disembodiment that was a vital component of the liberal tradition.<br>
                    These authors discuss how the contrast between embodiment and disembodiment has fractured into more complex and varied formations. Katherine Hayle stresses that the repositioning of materiality is distinct from physicality and re-envisioning the material basis for hybrid texts and subjectivities (Hayles).
                </p>
                ...
                <p class="stext">
                    ...
                    製作、儲存、傳輸這三種行為皆與信息、主體身體和文本相關連，因此，透過分析這些模態如何影響信息、主體身體和文本，藝術作品、藝術家的主體性以及數位物件得以被明確表達出來。<br><br>
        ...
        <section class="bgblack pd40120">
            <div class="row">                
                <div class="col-xl-8 col-9 col-auto">                    
                    <div class="text-center mb80">
                        <b class="bdr">FULL TEXT</b>
                    </div>
                    <ul class="full-text">    
                        <li class="active">
