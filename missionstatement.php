    ...
    <div id="Wapper">
        ...
        <div class="row">
            <div class="col-xl-8 col-9 col-auto">
                ...
                <h2 class="h2title">DORD:THE INTRODUCTION OF KEYWORD DICTIONARY OF CONTEMPORARY ART</h2>
                <div class="stext">
                ...
                <h2 class="h2title">Dord:當代藝術關鍵字辭典計畫</h2>
                <div class="stext">
