    ...
    <div id="Wapper">
        ...
        <div class="row">
            <div class="col-xl-8 col-9 col-auto">
                ...
                <h2 class="h2title">Dord:亞洲當代藝術關鍵字辭典計畫</h2>
                <div class="stext">
                    <b>「這太糟糕了，為什麼dord 無法代表密度？」</b>
                    <br><br>            
                    「Dord」是一個誤被收錄到字典裡並且被視為「單字」的無意義拼字，起源於一名編輯的抄錄疏失，這個字彙只出現在偉柏字典裡16年，就被編輯 菲利浦（Philip Babcock Gove）發現並且在1947年刪除，在這之前這個單字的定義是：「名詞，物理與化學。密度的縮寫。（dord (dôrd), n. Physics & Chem. Abbreviation for density. ）」如同躲藏在字典裡的幽靈字一般，在這個不斷發展出新的字彙並且透過日漸強大的自我搜索功能翻掘出新的關鍵字的時代，如果有一本關鍵字字典得以指出今日世界的範疇，同時透過自我建構的過程中省思在全球化以及知識建構體系仍必須面對上個世紀以來殖民幽靈的困擾所造成的缺漏，並且為字典的編纂及閱讀者提出對於未來的想像，可能這本字典的形式會更趨近於一個事件、一場表演或是一條開放的原始碼，並且可以被不斷地被觸發、被截取並且成為新的事件、表演以及創造物的元件。<br><br>

                    「亞洲當代藝術關鍵字字典計畫」始於2021年，因為新冠疫情所帶來的全球疆域封鎖、交通運輸困難、由於經濟陷入低谷間接被激化的衝突，以及新的字彙如「#Stayhome」、「#Stayhealth」、「#Quarantine」等標籤（Hashtag）在社群媒體的大量使用。疫情期間，藝術工作者之間的實體交流變得困難，但這也意謂著更多的時間重新檢視、歸檔過往成果並且思考未來可能的行進方向。本計畫希望從共享文化知識與歷史經驗的亞洲地區出發，將臺灣視為一個節點，串聯起位於東南亞及南亞的藝術工作者們，自彼此的共同經驗出發，針對共同面對的問題提出回應抑或是持續探問。在第一期的計畫當中，邀請了三名主持人擬定主題，與來自印尼、阿美族、南亞與菲律賓的藝術家、藝術教育工作者、協作者們分別以影像、聲音、文字及出版品做出回應。在此之中，主持人的角色更近似於一名索引編輯，透過設計閱讀方式為所提出的關鍵字定錨。也因此本計畫的網路展示設計仍然採用現代字典慣用的編排方式：依據字母排續，並且盡可能保留以母語做為發想而出現單字及過程。<br><br>
