...
<body class="lang_tw">
    ...
    <div id="Wapper" class="pdbtm">
        <div class="bread">
            ...
            <a class="active">The history of the territory</a>
        </div>        
        <section class="row">
            ...
            <div class="col-xl-8 col-9 col-auto">
                ...
                <figure>
                    <img src="dist/images/astronesian/img1.png" class="w100">
                    <figcaption>Rijsttafel, Indonesian, 2021 Image courtesy: Angga Cipta</figcaption>
                </figure>
                <div class="mb80"></div>
                <p class="stext">                    
                ...
                <figure>
                    ...
                    <figcaption>Warung, Indonesian, 2022 Image courtesy: Angga Cipta</figcaption>
                </figure>
                <div class="mb80"></div>
                <p class="stext">
                ...
                <div class="text-center">
                    <figure>
                        <img src="dist/images/astronesian/Big-Village.png">
                        <figcaption>The poster of Big Village(1969)</figcaption>
                    </figure>
                </div>
                <div class="mb80"></div>
                <p class="stext">
                ...
                <div class="text-center">
                    ...
                    <figure>
                        ...
                        <figcaption>
                            Reenactment of 60's college student movement in movie Gie(2005). Screen Shooting, Image courtesy:<a href="https://en.wikipedia.org/wiki/Gie" target="_blank">https://en.wikipedia.org/wiki/Gie</a>
                        </figcaption>
                    </figure>
                </div>
                <div class="mb80"></div>
                ...
                <p class="stext">
                    <b class="fs18">地區歷史</b><br><br>
                    雅加達是印度尼西亞所有種族的大熔爐之地，幾乎每一個主要族群都有自己的村莊（Kampung）或社群聚落，包括峇里、安汶、布吉、馬來、班達、阿拉伯、爪哇等等。這些村落近期已發展成為更加多元的社會，與它們的文化起源僅保有少數連結。每一個村落的相似處在於高人口密度及其所帶動的社群凝聚力，還有在地居民濃濃的人情味。不過，村落依然存在於印尼各大城市的原因究竟為何？
                </p>
                <div class="mb80"></div>
                <p class="stext">
                    <b class="fs18">村落中的各式香料</b><br><br>
                    如果把分散在各村落的族群比喻為香料，不同的香料就會做出不同的菜餚。在城市裡以種族為組成依據的村落，族群認同感正持續在被同化。每個村落都像是代表不同的食材，而寫在他們體內的文化DNA，則造就出不同的文化特性。口音、屬於在地的口語表達方式以及使用的方式和時機，對母語人士而言都有不同的感受。所以當我到雅加達不同區域的村落時，從文化層面上來說，感覺就像在吃什錦飯。<br><br>

                    什錦飯的存在，與另一道菜「Rijsttafel」的關係密不可分。過去這道菜是把幾碟不同的菜餚放在一個大盤子上享用，名稱取自荷蘭文，意即「 飯桌   」。這樣的擺盤方式能呈現不同地區的菜色，通常搭配一碗米飯，或是米飯和蔬菜咖哩，就像是飲食文化版的「殖民博覽會」（Koloniale Tentoonstelling）。源自不同族群的在地菜色，讓這道美食饗宴充滿異國風情，深深吸引著饕客，例如西蘇門答臘的仁當、混和印尼和中國菜式的紅燒豬肉／滷肉、雅加達的加多加多水煮青菜沙拉、巽他的Karedok生菜沙拉、爪哇的雞肉沙嗲、爪哇和巽他的辣汁炸蛋⋯⋯等等。<br><br>

                    經過數十年，「<a href="">飯桌<i class="fa-solid fa-headphones"></i></a>」的飲食概念轉變為什錦飯，在當地較常被稱呼為nasi rames，這一詞由 <a href="#">warung—warteg（Warung Tegal）<i class="fa-solid fa-headphones"></i></a> —演變而來，意指在印尼各大城市中的食物攤販。Rames是爪哇文Ora Mesti 的簡稱，意思是你「不需要」用同樣的菜色搭配白飯。攤販的櫥窗擺設非常特別，所有的食物都整齊排列，你只需要直接指出想吃的哪一道菜。米南人開的巴東料理攤販或是西蘇門答臘餐廳也一樣，從印尼城市隨處可見的攤販和巴東餐廳，可以看出爪哇人和米南人移居的人口數，他們需要來自老家的靈魂料理，撫慰想念家鄉味的心。
                </p>
                <div class="mb80"></div>
                <p class="stext">
                    <b class="fs18">家（屋）</b><br><br>
                    想像雅加達是你現在只能在電影中見到、還處於國家發展剛起步的階段。導演烏斯馬爾伊斯邁耳1969年的電影《大村莊》（Big Village）描繪雅加達在「新秩序時代」的轉變，海報上寫著「雅加達，我所喜愛的城市」。雅加達現在看起來是個真正的「大村莊」，以村落為主的區域擴散在五個地方：中部、北部、南部、東部和西部。雅加達自1966年成為特別首都地域之後，極速擴張使得都市人口高度成長。甚至早在1966年前，雅加達就已經邀請來自其他省份或島嶼的人民移入。「我所喜愛的城市」這樣的精神，也影響了都市計畫結構，可說是由原始居民和外來居民共同形塑成的有機發展模式。<br><br>

                    當時的省長名叫阿里沙迪京，他發起一項名為MHT的振興計畫，MHT一詞取自印尼巴達維亞首位人民政府委員會成員穆罕默德胡斯尼譚林姓名的首字。這項振興計畫也被稱為村落發展計畫，並帶來廣泛的影響，包括改善環境整潔、提升居民健康水平，或至少帶來一定程度的進步，擺脫過去更為落後的條件。優先能夠獲得改善的村落，包括缺乏良好的人車用道路建設，或是因池塘及沼澤充滿積水，有可能滋生蚊蟲、衍生瘧疾或登革熱的地方。<br><br>
                ...
                <div class="mb80"></div>
                <p class="stext">
                    <b class="fs18">凝聚力與擬訂策略</b><br><br>
                    我研究過這些移入人口的創業歷程，他們從沿路叫賣菸煙、騎腳踏車或用手推攤車販賣飲料 (通常是即溶咖啡)，最後才賣炒飯。整個歷程進展的速度，取決於當地的小販聚會，他們會在某個地方交流資訊：哪裡可以找到最多的買家、近期會發生哪些活動、可以提高售價的服務，或者只是閒聊一些在社群軟體上看到的時事。這個聚會不是官方組職，沒有既定架構和成員組織，就只是大家開工之前，在固定時間會聚集交流的地方。聚會由外來小販共同的家鄉發枝散葉，主要是馬都拉或爪哇北岸的某些城市。<br><br>

                    這樣的聚會模式不只存在小販之間，也可見於社會中的各個階層。最基本的聚會模式就是出門和別人見面，通常稱為nongkrong，直譯是「佔據、各據一地」的意思，在任何時候於城市的各個角落都可以見到。透過這樣的交流，人們可以驗證或梳理自己腦中相互關聯並持續在演變的想法，結果也許只是某種在地的口語表現，或某種做事的方式，但這是都是文化的產物，最終將成為屬於該區域的標誌性特色。<br><br>
